...
def get_Sum(segment_tree,start,end,q_start,q_end,i):
	...
	mid = (start+end)//2
	l = get_Sum(segment_tree,start,mid,q_start,q_end,2*i+1)
	r = get_Sum(segment_tree,mid+1,end,q_start,q_end,2*i+2)
	return l+r
